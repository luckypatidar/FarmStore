...
public class ProductSpecificationAdaptar extends RecyclerView.Adapter<ProductSpecificationAdaptar.ViewHolder> {
    ...
    @NonNull
    @Override
    public ProductSpecificationAdaptar.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductSpecificationAdaptar.ViewHolder viewHolder, int position) {
        switch (productSpecificationModelList.get(position).getType()) {
            case ProductSpecificationModel.SPECIFICATION_TITLE:
