...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    private TextView orderedTitle, packedTitle, shippedTitle, deliverdTitle;
    private TextView orderedDate, packedDate, shippedDate, deliverdDate;
    private TextView orderedBody, packedBody, shippedBody, deliverdBody;
...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        quantity = findViewById(R.id.product_quatity);
        ...
        deliverdTitle = findViewById(R.id.delivered_title);
        ...
        deliverdDate = findViewById(R.id.deliverd_date);
        ...
        deliverdBody = findViewById(R.id.delivered_body);
        ...
        deliveryPrice = findViewById(R.id.delivery_price_);
        ...
        switch (model.getOrderStatus()) {
            case "Ordered":
                ...
                deliverdBody.setVisibility(View.GONE);
                deliverdTitle.setVisibility(View.GONE);
                deliverdDate.setVisibility(View.GONE);
                break;
            case "Packed":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successgreen)));
                orderedDate.setText(String.valueOf(simpleDateFormat.format(model.getOrderedDate())));
            ...
            case "Out for Delivery":
                ...
                deliverdDate.setText(String.valueOf(simpleDateFormat.format(model.getDeliveredDate())));
                ...
                deliverdTitle.setText("Our for Delivery");
                deliverdBody.setText("Your order is out for delivery.");
                break;
            case "Delivered":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.successgreen)));
                orderedDate.setText(String.valueOf(simpleDateFormat.format(model.getOrderedDate())));
            ...
            case "Cancelled":
                ...
                if (model.getPackedDate().after(model.getOrderedDate())) {
                    ...
                    if (model.getShippedDate().after(model.getPackedDate())) {
                        ...
                        deliverdDate.setText(String.valueOf(simpleDateFormat.format(model.getCancelledDate())));
                        deliverdTitle.setText("Cancelled");
                        deliverdBody.setText("Your order has been cancelled.");
        ...
        if (model.isCancellationRequested()) {
            ...
            cancelOrderBtn.setText("Cancellation is in process");
